      ...
      <div className="landing-bkgr">
        <div className="row">
          ...
          <div className="name-written col-7">
            ...
            <div className="name-subtitle">service designer</div>

            <div className="snippet">
              <p className="striped">
                I work as an interdisciplinary{" "}
                <span>Service and UX/UI designer</span> specialized in{" "}
                <span>Product Management</span>,{" "}
                <span>digital business intelligence</span> and{" "}
        ...
        <div className="row lading-bottom-box justify-content-md-center">
          <div className="col-4">
          ...
          <div className="col-12 justify-content-md-center">
            ...
            <div className="phrase-box">
              Nunc maximus orci eget pretium scelerisque. Nulla tempor id nibh
              et mattis. Morbi quis sodales felis. Curabitur in urna vel ligula
              consectetur volutpat. Nunc ut libero nec ante tincidunt sagittis.
              Sed lacus mauris, mollis sed eleifend in, mattis eu quam. Nullam
              metus lacus nulla.
            </div>
          </div>
        </div>
