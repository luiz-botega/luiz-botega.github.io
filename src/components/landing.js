...
export default function Landing(props) {
  let landing = (
    <div className="landing-bkgr">
      ...
      <div className="row lading-bottom-box">
        <div className="col-xl-12 justify-content-md-center">
          <div className="contact-button col-1">
            <div>
        ...
        <div className="col-xl-12 justify-content-md-center">
          ...
          <div className="phrase-box">
            Nunc maximus orci eget pretium scelerisque. Nulla tempor id nibh et
            mattis. Morbi quis sodales felis. Curabitur in urna vel ligula
